...
# -*- encoding: utf-8 -*-
# stub: sidekiq-pro-dynamic-queues 0.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Matt Conway", "Andre Foeken"]
  s.date = "2015-03-06"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<sidekiq-pro>, [">= 2.0.0"])
    else
      ...
      s.add_dependency(%q<sidekiq-pro>, [">= 2.0.0"])
    end
  else
    s.add_dependency(%q<jeweler>, [">= 0"])
    s.add_dependency(%q<gemfury>, [">= 0"])
